                    ...
                    <div class="col-lg-12">
                        <form id="registrationForm">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="email" placeholder="Email Address" id="userEmail">
                            </div>
                             <div class="form-group">
                                <label for="userPass">Password</label>
                                <input class="form-control" type="password" placeholder="password" id="userPass">
                                <label for="userPassConfirm">Confirm Password</label>
                                <input class="form-control" type="password" placeholder="confirm password" id="userPassConfirm">
                            </div>
                        </form>
